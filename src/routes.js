...
routes.post('/ads', handle(validate(validators.Ad), controllers.AdController.store))
routes.put('/ads/:id', handle(validate(validators.Ad), controllers.AdController.update))
